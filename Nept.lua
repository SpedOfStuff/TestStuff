...
for i,v in pairs(mas:GetChildren()) do
	v.Parent = game:GetService("Players").LocalPlayer.Character.Reanimation
...
char = plr.Character.Reanimation
hum = char.Humanoid
...
Character=Player.Character.Reanimation
...
Align(Hat.Handle,AlignChar.Reanimation.Model.Part,Vector3.new(0,-0.1,0),Vector3.new(0,90,60))
