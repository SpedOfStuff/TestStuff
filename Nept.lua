...
for i,v in pairs(mas:GetChildren()) do
	v.Parent = game:GetService("Players").LocalPlayer.Character.CoolHubTutorial
...
char = plr.Character.CoolHubTutorial
hum = char.Humanoid
...
Character=Player.Character.CoolHubTutorial
...
Align(Hat.Handle,AlignChar.CoolHubTutorial.Model.Part,Vector3.new(0,-0.1,0),Vector3.new(0,90,60))
